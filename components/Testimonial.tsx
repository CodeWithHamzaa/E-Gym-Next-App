...
const testimonialData = [
    {
        ...
        message: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio culpa, eveniet suscipit quaerat dicta ad.',
        name: 'Lucy Smith',
    },
    {
                            ...
                            return (
                                <SwiperSlide className="h-full" key={index}>
                                    <div className="flex flex-col justify-center items-center text-center gap-6 h-full">
                                        <Image src={person.img} width={90} height={80} alt="" className="rounded-full border-2 border-accent"/>
